...
export default function PageHero({
    ...
    return (
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {onBack && (
                <div className="hidden 2xl:block absolute left-[-44px] top-1/2 -translate-y-1/2">
                    <button
                        onClick={onBack}
            ...
            <div className="py-6 md:py-8 flex flex-col md:flex-row md:items-center justify-between gap-6 overflow-hidden">
                <div className="flex items-start gap-4 md:gap-6">
                    ...
                    {onBack && (
                        <button
                            onClick={onBack}
                            className="2xl:hidden flex-shrink-0 flex items-center justify-center w-[48px] h-[48px] md:w-[57px] md:h-[57px] bg-white border border-neutral-grey-200 rounded-[10px] text-neutral-grey-800 hover:bg-neutral-grey-50 transition-colors"
                            aria-label="Retour"
                        >
