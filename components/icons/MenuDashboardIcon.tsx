...
export function MenuDashboardIcon({ className }: IconProps) {
    return (
        <svg className={className} width="30" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
